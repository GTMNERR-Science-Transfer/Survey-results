...
## 4.3 Details on dataset usage, advantages, disadvantages, and satisfaction
...
txt_data_yes_YD3 %>% 
  ...
  pack_rows(index = index_table)
```
``` {r otheradvantages_table2, echo = FALSE, warning = FALSE, message = FALSE}
# Try something else here: create separate tables for each dataset. Put methods of obtaining in first column, next columns are advantages and disadvantages, and maybe text for other? If this works, take advantages and disadvantages out of the main table.
...
adv_full_overview <- yes_data_adv %>% 
...
disadv_bysource2 <- disadv_bysource %>% 
  pivot_wider(names_from = Disadvantage, values_from = percentage,
              values_fill = 0)
