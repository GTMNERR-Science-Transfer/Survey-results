...
Essentially, the three usages mentioned here most are personal use, volunteer activities, and management purposes (vegetation / invasive plants, prescribed fire). 
...
#### MAYBE ACTUALLY MAKE THIS A PLOT??? Or save as appendix
...
#             index=c("Disadvantage","q_text"), #index=c("q_text","Disadvantage"), 
#             vSize="percentage",
#             type="index",
#             palette = "Set2",
#             #bg.labels=c("white"),
...
browsable(
  tagList(
    ...
    d3tree2(treemap(disadv_bysource,
            index=c("Disadvantage",ln_break("q_text_num")), 
            vSize="percentage",
            type="index",
            palette = "Set2",
