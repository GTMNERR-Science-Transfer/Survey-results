...
The figure below shows that 25% (2 respondents) were not interested in accessing data, and that about half of the respondents would either access data either once a month or once a year (25% each).
...
- The overwhelming majority of respondents prefers to access a data dashboard on their computer. Slightly less than 50% would (also) want to access it on a cellphone.
