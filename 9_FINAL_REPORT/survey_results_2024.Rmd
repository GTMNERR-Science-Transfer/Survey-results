...
The next figure, a so-called treemap, shows the information for the same questions but summarized differently; based on the advantages. The size of the rectangle for each advantage indicates the percentage of respondents that picked this advantages compared to all advantage answers (outer box). Clicking on each rectangle then shows the data access methods for which this advantage was picked; also by percentage. A hover label shows the percentages as text, as well as the advantages or access methods if the text is too long to be readily readable.
