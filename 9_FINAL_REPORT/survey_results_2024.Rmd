...
Based on their answer here, respondents were directed to different survey sections. Part 3 of this reports on questions for those who anwered "No", Part 4 on questions for those who answered "Yes".

```{r accessed_data, fig.width = 4, fig.height = 3, echo = FALSE, message = FALSE, fig.align = 'center'}
#### CHECK IF N=51 IS CORRECT
ggplot(intro %>% 
         filter(qname == "D-4") %>% 
         group_by(q_text) %>%
         summarize(cnt = n()) %>%
